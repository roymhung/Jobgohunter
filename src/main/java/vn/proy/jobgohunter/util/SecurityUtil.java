...
public class SecurityUtil {
    ...
    @Value("${jobgohunter.jwt.access-token-validity-in-seconds}")
    ...
    public String createAccessToken(Authentication authentication, ResLoginDTO.UserLogin dto) {
        ...
        // hardcode permission(for test) => sau nay se lay tu DB
    ...
    public Jwt checkValidRefreshToken(String token) {
        // decode token => check valid => get email => get user => create new access token
